...
2 degrees of freedom, the Cauchy distribution and the Poisson distribution with mean 1. Three choices of 
a transformation $f$ of $X_k$ can also be made.

The figures show the sequence(s) of random variables $f(X_n)$ and the sample path for the 
